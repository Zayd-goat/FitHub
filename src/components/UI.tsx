...
import { Pressable, RefreshControl, ScrollView, ScrollViewProps, StyleProp, StyleSheet, Text, TextInput, TextInputProps, useColorScheme, View, ViewStyle } from 'react-native';
...
export function RefreshableScrollView({ onRefresh, ...props }: Omit<ScrollViewProps, 'refreshControl'> & { onRefresh?: () => Promise<unknown> | unknown }) {
  ...
  return <ScrollView alwaysBounceVertical overScrollMode="always" {...props} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={refresh} colors={[colors.primary]} tintColor={colors.primary} progressBackgroundColor={colors.panel} />} />;
}
