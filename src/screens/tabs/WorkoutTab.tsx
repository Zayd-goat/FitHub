...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  muscleGridCard: { width: '48.5%', aspectRatio: .92, borderRadius: 15, overflow: 'hidden', backgroundColor: colors.panel, borderWidth: 1, borderColor: colors.border, position: 'relative' },
  muscleGridImage: { width: '100%', height: '73%', resizeMode: 'contain', backgroundColor: colors.panel },
  muscleGridCardio: { width: '100%', height: '73%', resizeMode: 'contain', backgroundColor: colors.panel },
  muscleGridCopy:{height:'27%',justifyContent:'center',paddingHorizontal:12,backgroundColor:colors.panel},
