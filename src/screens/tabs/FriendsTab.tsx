...
const styles = StyleSheet.create({
  ...
  person: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, gap: 10 }, avatar: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#143d69', alignItems: 'center', justifyContent: 'center' }, avatarText: { color: colors.text, fontWeight: '900' }, name: { color: colors.text, fontWeight: '900' }, meta: { color: colors.muted, fontSize: 11, marginTop: 2, lineHeight: 16 },
  small: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 11, backgroundColor: '#123a68' }, smallText: { color: colors.text, fontWeight: '900', fontSize: 12 }, post: { color: colors.text, fontSize: 16, lineHeight: 22, marginVertical: 8, fontWeight: '700' },
  comment: { backgroundColor: '#081a35', borderRadius: 12, padding: 9, marginTop: 6 }, commentAuthor: { color: colors.cyan, fontWeight: '900', fontSize: 11 }, commentBody: { color: colors.text, marginTop: 2 }, commentInput: { flexDirection: 'row', gap: 8, alignItems: 'center', marginTop: 9 }, send: { backgroundColor: colors.blue, borderRadius: 12, paddingHorizontal: 13, minHeight: 48, justifyContent: 'center' }, sendText: { color: 'white', fontWeight: '900' },
  chips: { flexDirection: 'row', flexWrap: 'wrap' }, two: { flexDirection: 'row', gap: 8 }, challengeTop: { flexDirection: 'row', alignItems: 'flex-start', gap: 8 }, challenge: { color: colors.text, fontSize: 17, fontWeight: '900' }, progress: { color: colors.cyan, fontSize: 18, fontWeight: '900', marginTop: 10 }, track: { height: 8, borderRadius: 999, backgroundColor: '#102443', overflow: 'hidden', marginVertical: 7 }, fill: { height: '100%', backgroundColor: colors.purple }
});
