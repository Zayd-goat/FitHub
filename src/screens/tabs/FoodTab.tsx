...
const styles = StyleSheet.create({
  ...
  macroRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 12 }, mini: { width: '48%', backgroundColor: '#081a36', borderWidth: 1, borderColor: colors.border, borderRadius: 16, padding: 12 }, miniValue: { color: colors.text, fontWeight: '900', fontSize: 16 }, miniLabel: { color: colors.cyan, fontSize: 11, marginTop: 2, fontWeight: '800' },
  ...
  foodRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.panel, borderWidth: 1, borderColor: colors.border, borderRadius: 16, padding: 13, marginBottom: 8 }, foodName: { color: colors.text, fontWeight: '900' }, foodMeta: { color: colors.muted, fontSize: 11, marginTop: 3, lineHeight: 16 }, kcal: { color: colors.cyan, fontWeight: '900' }, add: { backgroundColor: '#123a68', borderRadius: 12, paddingHorizontal: 11, paddingVertical: 9, marginLeft: 8 }, addText: { color: colors.text, fontWeight: '900' },
  logRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 9, borderBottomWidth: 1, borderBottomColor: '#10284b' }
});
