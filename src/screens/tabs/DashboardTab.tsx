    ...
    <View style={styles.page}>
      ...
      <RefreshableScrollView onRefresh={load} contentContainerStyle={styles.wrap} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.quickBottomRow}>
          <WideQuickCard icon={<TrophyIcon color={colors.text} accentColor={colors.primary}/>} label={'Community\nChallenges'} onPress={onOpenChallenges}/>
          <WideQuickCard icon={<RunIcon color={colors.text} accentColor={colors.primary}/>} label="Run Metrics" onPress={() => onViewProgress('overview')}/>
        </View>
