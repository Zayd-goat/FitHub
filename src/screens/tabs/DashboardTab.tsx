...
const createStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  quickTopRow: { flexDirection: 'row', gap: 9, marginBottom: 9 }, quickBottomRow: { flexDirection: 'row', gap: 9, marginBottom: 18 }, quickCard: { flex: 1, minHeight: 132, borderRadius: 18, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panel, alignItems: 'center', justifyContent: 'center', shadowColor: colors.shadow, shadowOpacity: isDark ? .2 : .08, shadowRadius: 8,shadowOffset:{width:0,height:3},elevation:3 },quickIconStage:{width:62,height:62,borderRadius:20,backgroundColor:colors.primarySoft,alignItems:'center',justifyContent:'center'}, quickLabel: { color: colors.text, fontSize: 11, fontWeight: '900', marginTop: 8 },quickArrow:{position:'absolute',right:9,top:8,color:colors.muted,fontSize:17}, wideQuickCard: { flex: 1, minHeight: 84, borderRadius: 17, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panel, flexDirection: 'row', alignItems: 'center', paddingHorizontal:11,gap: 9 },wideIconStage:{width:50,height:50,borderRadius:16,backgroundColor:colors.primarySoft,alignItems:'center',justifyContent:'center'}, wideQuickLabel: { color: colors.text, fontSize: 12, fontWeight: '900', lineHeight: 16,flex:1 },wideArrow:{color:colors.muted,fontSize:20},
