...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  nav: { minHeight: 88, flexDirection: 'row', borderTopWidth: 1, borderTopColor: colors.border, backgroundColor: colors.nav, paddingBottom: 12, paddingTop: 8, overflow: 'visible', shadowColor:'#000',shadowOpacity:.12,shadowRadius:10,shadowOffset:{width:0,height:-2},elevation:12 },
  navItem: { flex: 1, minHeight: 64, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  navPressed: { opacity: 0.68 },
  activeBar: { position: 'absolute', top: -8, width: 34, height: 4, borderRadius: 999, backgroundColor: colors.primary },
  iconWrap: { width: 46, height: 36, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  trainButton: { width: 62, height: 62, borderRadius: 31, marginTop: -30, backgroundColor: colors.primary, borderWidth: 5, borderColor: colors.nav, shadowColor:'#000',shadowOpacity:.3,shadowRadius:10,shadowOffset:{width:0,height:5},elevation:11 },
