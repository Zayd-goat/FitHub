...
- The two TypeScript errors reported by GitHub run `89858110434` were corrected in `NotificationsScreen.tsx` and `WorkoutHistoryScreen.tsx`.
...
- A fresh GitHub Actions `npm ci` and strict TypeScript check after the CI corrections.
