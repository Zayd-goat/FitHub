...
- High-to-Low Cable Fly — both pulleys visibly high; handles travel downward and inward.
- Low-to-High Cable Fly — both pulleys visibly low; handles travel upward and inward.
- Pec Deck / Pec Deck Fly — seated supported pec-deck machine with the padded lever arms visible; no cable crossover substitution.
- Weighted Push-Up — straight-body floor push-up with one secured plate clearly visible across the upper back.
- Machine Row / Seated Row Machine — actual chest-supported plate-loaded row machine; no loose-barbell substitution.
- One-Arm Dumbbell Row — one knee and hand supported on a bench; exactly one dumbbell rows toward the hip.
- Pendlay Row — pronated barbell row from a near-horizontal hinged torso with the full bar and plates visible.
- Straight-Arm Pulldown — high cable and straight attachment; standing with fixed, nearly straight elbows; no seated-row substitution.
